...
<head>
    ...
    <title>Demande de devis - BideanTrail</title>
</head>
<body>
<div class="container">
    <div class="header">
        <h1>Demande de devis prise en compte</h1>
        <p>Vous avez fait une demande de devis sur le site de BideanTrail. La demande à bien été envoyée, nous prendrons contact avec vous pour la prise en charge de la commande.</p>
